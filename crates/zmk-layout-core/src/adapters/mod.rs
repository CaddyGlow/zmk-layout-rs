...
pub use standard::{
    ...
    render_standard_template_for_profile, template_contains_placeholders, AdapterError,
    AdapterLayout, BehaviorSpec, ComboSpec, RegexExtractionConfig, TemplateParseMode,
};
