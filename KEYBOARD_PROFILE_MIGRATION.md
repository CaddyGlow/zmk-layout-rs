...
and a first profile (`keyboard_profiles/glove80.toml`). This plan outlines how to
...
> Status: Completed – added `src/profiles/mod.rs`, `keyboard_profiles/glove80.toml`
